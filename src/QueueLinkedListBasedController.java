...
public class QueueLinkedListBasedController implements Initializable {
    ...
    private QueueLinkedListBased_Capote empQueueLinkedList;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        DSComboBox.getSelectionModel().select(5);
    ...
    public void offerEmployee(ActionEvent event) {
        ...
        if(!nameField.getText().isEmpty() && !positionField.getText().isEmpty() && !ageField.getText().isEmpty() && !IDField.getText().isEmpty()) {
            ...
            if(ErrorProof.isSameID(empQueueLinkedList.getHead(), IDField.getText().trim())) {
                ...
                empQueueLinkedList.offer(emp);
                DataRepository.importLinkedList(empQueueLinkedList.getHead(), empQueueLinkedList.getSize());
                updateTable();
            }
        }
    ...
    public void peekEmployee(ActionEvent event) {
        ...
        if(empQueueLinkedList.getSize() < 1) {
        ...
        employeeTable.getSelectionModel().select(empQueueLinkedList.peek());

        nameField.setText(empQueueLinkedList.peek().getName());
        positionField.setText(empQueueLinkedList.peek().getPosition());
        ageField.setText(String.valueOf(empQueueLinkedList.peek().getAge()));
        IDField.setText(empQueueLinkedList.peek().getID());
    }
    ...
    public void containsEmployee(ActionEvent event) {
        ...
        if(empQueueLinkedList.getSize() < 1) {
            ...
            if(empQueueLinkedList.contains(new Employee(name, position, age, ID))) {
    ...
    public void updateTable() {
        ...
        empQueueLinkedList = new QueueLinkedListBased_Capote();
        ...
        if(!empQueueLinkedList.isEmpty()) {

            Employee nav = empQueueLinkedList.getHead();

            for (int i = 0 ; i < empQueueLinkedList.getSize() ; i++) {
