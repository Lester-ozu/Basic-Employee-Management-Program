...
public class QueuePredefinedController implements Initializable {
    ...
    private Queue<Employee> empQueue;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        DSComboBox.getSelectionModel().select(9);
    ...
    public void offerEmployee(ActionEvent event) {
        ...
        if(!nameField.getText().isEmpty() && !positionField.getText().isEmpty() && !ageField.getText().isEmpty() && !IDField.getText().isEmpty()) {
            ...
            if(ErrorProof.isSameID(empQueue, IDField.getText().trim())) {
                ...
                empQueue.offer(emp);
                DataRepository.importQueue(empQueue);
                updateTable();
            }
        }
    ...
    public void peekEmployee(ActionEvent event) {
        ...
        employeeTable.getSelectionModel().select(empQueue.peek());

        nameField.setText(empQueue.peek().getName());
        positionField.setText(empQueue.peek().getPosition());
        ageField.setText(String.valueOf(empQueue.peek().getAge()));
        IDField.setText(empQueue.peek().getID());
    }
    ...
    public void containsEmployee(ActionEvent event) {
        ...
        if(empQueue.size() < 1) {
            ...
            if(empQueue.contains(new Employee(name, position, age, ID))) {
    ...
    public void updateTable() {
        ...
        empQueue = new LinkedList<Employee>();
