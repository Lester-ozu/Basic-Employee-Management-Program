...
public class StackPredefinedController implements Initializable {
    ...
    private Stack<Employee> empStack;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        DSComboBox.getSelectionModel().select(8);
    ...
    public void pushEmployee(ActionEvent event) {
        ...
        if(!nameField.getText().isEmpty() && !positionField.getText().isEmpty() && !ageField.getText().isEmpty() && !IDField.getText().isEmpty()) {
            ...
            if(ErrorProof.isSameID(empStack, IDField.getText().trim())) {
                ...
                empStack.push(emp);
                DataRepository.importStack(empStack);
                updateTable();
            }
        }
    ...
    public void peekEmployee(ActionEvent event) {
        ...
        employeeTable.getSelectionModel().select(empStack.peek());

        nameField.setText(empStack.peek().getName());
        positionField.setText(empStack.peek().getPosition());
        ageField.setText(String.valueOf(empStack.peek().getAge()));
        IDField.setText(empStack.peek().getID());
    }
    ...
    public void searchEmployee(ActionEvent event) {
        ...
        if(empStack.size() < 1) {
            ...
            int index = empStack.search(new Employee(name, position, age, ID));
