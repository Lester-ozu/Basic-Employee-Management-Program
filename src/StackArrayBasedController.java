...
public class StackArrayBasedController implements Initializable {
    ...
    @FXML private Button pushButton, peekButton, popButton, emptyButton, searchButton;
    @FXML private ChoiceBox<String> DSComboBox;
    @FXML private AnchorPane scenePane;

    private StackArrayBased_Capote empStackArrayList;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        DSComboBox.getSelectionModel().select(2);
    ...
    public void pushEmployee(ActionEvent event) {
        ...
        if(!nameField.getText().isEmpty() && !positionField.getText().isEmpty() && !ageField.getText().isEmpty() && !IDField.getText().isEmpty()) {
            ...
            if(ErrorProof.isSameID(empStackArrayList.getList(), IDField.getText().trim())) {
                ...
                empStackArrayList.push(emp);
                DataRepository.importArrayList(empStackArrayList.getList(), empStackArrayList.getSize());
                updateTable();
            }
        }
    ...
    public void peekEmployee(ActionEvent event) {
        ...
        if(empStackArrayList.getSize() < 1) {
        ...
        employeeTable.getSelectionModel().select(empStackArrayList.peek());

        nameField.setText(empStackArrayList.peek().getName());
        positionField.setText(empStackArrayList.peek().getPosition());
        ageField.setText(String.valueOf(empStackArrayList.peek().getAge()));
        IDField.setText(empStackArrayList.peek().getID());
    }
    ...
    public void searchEmployee(ActionEvent event) {
        ...
        if(empStackArrayList.getSize() < 1) {
            ...
            int index = empStackArrayList.search(new Employee(name, position, age, ID));
    ...
    public void updateTable() {
        ...
        empStackArrayList = new StackArrayBased_Capote();
        ...
        if(!empStackArrayList.isEmpty()) {

            for (int i = 0 ; i < empStackArrayList.getSize() ; i++) {

                empObsList.add(empStackArrayList.getList()[i]);
            }
        }
