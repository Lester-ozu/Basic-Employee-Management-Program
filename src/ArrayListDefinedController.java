...
public class ArrayListDefinedController implements Initializable{
    ...
    @FXML private Button addButton, removeButton, updateButton, previousButton, searchButton, nextButton;
    ...
    private ArrayList_Capote empArrayList;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        indexField.textProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
                ...
                if(!indexField.getText().isEmpty()) {
                    ...
                    if(ErrorProof.checkIndex(indexField.getText().trim()) ||  Integer.parseInt(indexField.getText().trim()) > empArrayList.getSize()-1 ||
        ...
        DSComboBox.getSelectionModel().select(0);
    ...
    public void addEmployee(ActionEvent event) {
        ...
        if(!nameField.getText().isEmpty() && !positionField.getText().isEmpty() && !ageField.getText().isEmpty() && !IDField.getText().isEmpty()) {
            ...
            if(ErrorProof.isSameID(empArrayList.getList(), IDField.getText().trim())) {
                ...
                empArrayList.addItem(index, emp);
                DataRepository.importArrayList(empArrayList.getList(), empArrayList.getSize());
                updateTable();
            }
    ...
    public void removeEmployee(ActionEvent event) {
        ...
        if(empArrayList.getSize() < 1) {

            Alert errorAlert = new Alert(AlertType.ERROR);
            errorAlert.setTitle("ERROR!");
            errorAlert.setHeaderText("An Error Occured :(");
            errorAlert.setContentText("There is nothing to remove\nSince the list is empty.");
        ...
        if (!IDField.getText().isEmpty()) {
            ...
            empArrayList.removeByID(IDField.getText().trim());
            DataRepository.importArrayList(empArrayList.getList(), empArrayList.getSize());
            updateTable();
        }
            ...
            empArrayList.removeByIndex(Integer.parseInt(indexField.getText().trim()));
            DataRepository.importArrayList(empArrayList.getList(), empArrayList.getSize());
            updateTable();
        }
    ...
    public void updateEmployee(ActionEvent event) {
        ...
        if(!nameField.getText().isEmpty() && !positionField.getText().isEmpty() && !ageField.getText().isEmpty() && !IDField.getText().isEmpty()) {
            ...
            if(!ErrorProof.isSameID(tempEmp, empArrayList.getList(), IDField.getText().trim())) {

                if(!empArrayList.update(tempEmp, name, position, age, ID)) {
    ...
    public void previousEmployee(ActionEvent event) {
        ...
        if(index <= 0) {
            ...
            employeeTable.getSelectionModel().select(empArrayList.getSize()-1);
        }
    ...
    public void nextEmployee(ActionEvent event) {
        ...
        if(index >= empArrayList.getSize()-1) {
    ...
    public void searchEmployee(ActionEvent event) {
        ...
        if(!IDField.getText().isEmpty()) {
            ...
            employeeTable.getSelectionModel().select(empArrayList.searchByID(IDField.getText().trim()));
        }

        else if(!indexField.getText().isEmpty()) {

            if(Integer.parseInt(indexField.getText().trim()) < empArrayList.getSize()) {
                
                employeeTable.getSelectionModel().select(Integer.parseInt(indexField.getText().trim()));
            }
        }
    }
    ...
    public void updateTable() {
        ...
        empArrayList = new ArrayList_Capote();
        ...
        if(!empArrayList.isEmpty()) {
            ...
            for (int i = 0 ; i < empArrayList.getSize() ; i++) {

                empObsList.add(empArrayList.getList()[i]);
            }
        }
