...
public class ArrayListPredefinedController implements Initializable{
    ...
    @FXML private Button addButton, removeButton, getButton, clearButton, setButton, indexOfButton;
    ...
    public void initialize(URL location, ResourceBundle resources) {
            ...
            public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
                ...
                if(ErrorProof.checkName(nameField.getText().trim())) {
                   ...
                   setButton.setDisable(true);
                    ...
                    indexOfButton.setDisable(false);
        ...
        indexField.textProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
                ...
                if(!indexField.getText().isEmpty()) {
                    ...
                    if(ErrorProof.checkIndex(indexField.getText().trim()) ||  Integer.parseInt(indexField.getText().trim()) > empArrayList.size()-1 ||
        ...
        DSComboBox.getSelectionModel().select(6);
    ...
    public void addEmployee(ActionEvent event) {
        ...
        if(!nameField.getText().isEmpty() && !positionField.getText().isEmpty() && !ageField.getText().isEmpty() && !IDField.getText().isEmpty()) {
            ...
            if(ErrorProof.isSameID(empArrayList, IDField.getText().trim())) {
                ...
                empArrayList.add(index, emp);
                DataRepository.importArrayList(empArrayList, empArrayList.size());
                updateTable();
            }
    ...
    public void removeEmployee(ActionEvent event) {
        ...
        if(empArrayList.size() < 1) {
            ...
            if(index > -1) {
                ...
                empArrayList.remove(Integer.parseInt(indexField.getText().trim()));
                DataRepository.importArrayList(empArrayList, empArrayList.size());
                updateTable();
            }
        }
    ...
    public void getEmployee(ActionEvent event) {
        ...
        if(!nameField.getText().isEmpty() && !positionField.getText().isEmpty() && !ageField.getText().isEmpty() && !IDField.getText().isEmpty()) {
            ...
            if(Integer.parseInt(indexField.getText().trim()) < empArrayList.size()) {
    ...
    public void indexOfEmployee(ActionEvent event) {
        ...
        if(!nameField.getText().isEmpty() && !positionField.getText().isEmpty() && !ageField.getText().isEmpty() && !IDField.getText().isEmpty()) {
            ...
            employeeTable.getSelectionModel().select(index);
            Employee emp = empObsList.get(index);
    ...
    public void updateTable() {
        ...
        if(!empArrayList.isEmpty()) {
            ...
            for (int i = 0 ; i < empArrayList.size() ; i++) {
                ...
                empObsList.add(empArrayList.get(i));
            }
        }
